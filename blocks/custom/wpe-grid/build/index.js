...
axios__WEBPACK_IMPORTED_MODULE_5___default.a.get(ajaxurl, {
  params: {
    action: 'wpe_frontspec',
    data: 'gridConfig'
  }
}).then(function (res) {
  var variations = res.data && res.data.variations ? res.data.variations : _config_json__WEBPACK_IMPORTED_MODULE_8__["variations"];
  variations.forEach(function (elt, index) {
    ...
    if (typeof elt.icon == 'string') {
      variations[index].icon = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_icons__WEBPACK_IMPORTED_MODULE_6__["Icon"], {
        icon: _icons__WEBPACK_IMPORTED_MODULE_7__[elt.icon]
      });
    }
  });
  console.log(variations);
  var configTotalColumns = res.data && res.data.totalColumns ? res.data.totalColumns : _config_json__WEBPACK_IMPORTED_MODULE_8__["totalColumns"];
  Object(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__["registerBlockType"])('custom/wpe-grid', {
    ...
    edit: Object(_edit__WEBPACK_IMPORTED_MODULE_9__["default"])(configTotalColumns),
    save: function save() {
