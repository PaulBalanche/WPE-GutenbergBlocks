...
/***/ "../../../../frontspec.json":
/*!**********************************************************************************************************************************************!*\
  !*** /Users/paulbalanche/www/bitbucket.org/buzzbrothers/Buzzbrothers/buzz-website-back-worpdress/web/app/themes/buzzbrothers/frontspec.json ***!
  \**********************************************************************************************************************************************/
/*! exports provided: components, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"components\":[{\"id\":\"content-basic\",\"name\":\"Content basic\",\"path\":\"components/content-basic\",\"props\":{\"title\":{\"label\":\"Title\",\"type\":\"string\"},\"body\":{\"label\":\"Body\",\"type\":\"richText\"},\"link\":{\"label\":\"Link\",\"type\":\"link\"},\"side\":{\"label\":\"Side\",\"type\":\"radio\",\"options\":[{\"key\":\"left\",\"label\":\"Left\"},{\"key\":\"right\",\"label\":\"Right\"}]}}},{\"id\":\"video\",\"name\":\"Video\",\"path\":\"components/video\",\"standalone\":true,\"props\":{\"video\":{\"label\":\"Video\",\"type\":\"object\",\"props\":{\"url\":{\"label\":\"Video\",\"type\":\"file\",\"root_prop\":\"src\"},\"type\":{\"label\":\"Type\",\"type\":\"select\",\"options\":[{\"key\":\"video\",\"label\":\"Video\"},{\"key\":\"vimeo\",\"label\":\"Vimeo\"}]},\"poster\":{\"label\":\"Poster\",\"type\":\"image\",\"root_prop\":\"src\"},\"fullscreen\":{\"label\":\"Fullscreen\",\"type\":\"boolean\",\"help\":[\"No\",\"Yes\"]}}}}},{\"id\":\"home-header\",\"name\":\"Home header\",\"path\":\"components/home-header\",\"standalone\":true,\"props\":{\"video\":{\"label\":\"Video\",\"type\":\"file\"}}},{\"id\":\"slider-vertical\",\"name\":\"Slider vertical\",\"path\":\"components/slider-vertical\",\"standalone\":true,\"props\":{\"timeout\":{\"label\":\"Timeout\",\"type\":\"number\"},\"slides\":{\"label\":\"Slides\",\"type\":\"object\",\"repeatable\":true,\"props\":{\"label\":{\"label\":\"Label\",\"type\":\"string\"},\"media_url\":{\"label\":\"Media\",\"type\":\"image\",\"root_prop\":\"src\"}}}}},{\"id\":\"header-image\",\"name\":\"Header image\",\"path\":\"components/about-header\",\"props\":{\"title\":{\"label\":\"Title\",\"type\":\"string\"},\"subtitle\":{\"label\":\"Subtitle\",\"type\":\"text\"}}},{\"id\":\"content-image-side\",\"name\":\"Content/image side\",\"path\":\"components/content-image-side\",\"props\":{\"title\":{\"label\":\"Title\",\"type\":\"string\"},\"body\":{\"label\":\"Body\",\"type\":\"richText\"},\"side\":{\"label\":\"Side\",\"type\":\"radio\",\"options\":[{\"key\":\"left\",\"label\":\"Left\"},{\"key\":\"right\",\"label\":\"Right\"}]},\"link\":{\"label\":\"Link\",\"type\":\"link\"},\"image\":{\"label\":\"Image\",\"type\":\"image\"}}},{\"id\":\"about-location\",\"name\":\"Listing location\",\"path\":\"components/about-locations\",\"props\":{\"locations\":{\"label\":\"Locations\",\"type\":\"object\",\"repeatable\":true,\"props\":{\"title\":{\"label\":\"Title\",\"type\":\"string\"},\"image\":{\"label\":\"Image\",\"type\":\"image\"}}}}}]}");
...
/* harmony import */ var _frontspec_json__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../../frontspec.json */ "../../../../frontspec.json");
var _frontspec_json__WEBPACK_IMPORTED_MODULE_14___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../../../../frontspec.json */ "../../../../frontspec.json", 1);
...
var WpeComponent = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(WpeComponent, [{
    ...
    value: function getMargin(type) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(currentMargin) == 'object' && currentMargin.hasOwnProperty(type)) {
    ...
    value: function setMargin(type, value) {
      ...
      this.props.setAttributes({
        margin: Object.assign(currentMargin, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, type, value))
      });
    }
  }, {
    ...
    value: function updateAttributes(arrayKey, currentValue, newValue) {
      ...
      this.setAttributes(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, keyToUpdate, newValueToUpdate[keyToUpdate]));
    }
  }, {
    ...
    value: function recursiveUpdateObjectFromObject(arrayKey, fromObject, newValue) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(fromObject) != 'object' || Array.isArray(fromObject) && typeof firstElement == 'string' || !Array.isArray(fromObject) && typeof firstElement == 'number') fromObject = typeof firstElement == 'string' ? {} : [];
    ...
    value: function renderControl(prop, keys, valueProp) {
      ...
      keys.forEach(function (element) {
        if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(currentValueAttribute) == 'object') {
      ...
      for (var keyLoop in currentValueAttribute) {
        ...
        switch (prop.type) {
          ...
          case 'object':
            if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(prop.props) == "object") {
              (function () {
    ...
    value: function renderToggleControl(id, label, help, keys, valueProp, objectValue) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_13__["ToggleControl"], {
        key: id,
        label: label,
        help: _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(help) == 'object' && Array.isArray(help) && help.length == 2 ? !!objectValue ? help[1] : help[0] : false,
        checked: objectValue,
        onChange: function onChange(newValue) {
    ...
    value: function renderFileControl(type, id, label, keys, valueProp, objectValue) {
      ...
      if (objectValue && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_2___default()(objectValue) == 'object') {
        switch (type) {
          case "image":
        ...
        preview = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])("div", {
          ...
          onClick: function onClick() {
            if (type == "gallery" && objectValue.length > 1) _this10.setAttributes(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, keys, objectValue.slice(0, objectValue.length - 1)));else if (repeatable) _this10.removeEltRepeatable(keys, valueProp);else _this10.setAttributes(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, keys, undefined));
          }
        }, "Remove"));
      }
    ...
    value: function render() {
      ...
      for (var key in _frontspec_json__WEBPACK_IMPORTED_MODULE_14__.components) {
        if (_frontspec_json__WEBPACK_IMPORTED_MODULE_14__.components.hasOwnProperty(key)) {
          var element = _frontspec_json__WEBPACK_IMPORTED_MODULE_14__.components[key];
          ...
          if (this.props.name == "custom/wpe-component-" + element.id) {
            ...
            for (var _i6 = 0, _Object$entries6 = Object.entries(catReOrder); _i6 < _Object$entries6.length; _i6++) {
              ...
              for (var _i7 = 0, _Object$entries7 = Object.entries(valCat.props); _i7 < _Object$entries7.length; _i7++) {
                ...
                currentEditCat.push(this.renderControl(prop, [_keyProp2], _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, _keyProp2, _valueProp2)));
              }
            ...
            return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_12__["InspectorControls"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_13__["PanelBody"], {
              ...
              onChange: function onChange(value) {
                return _this11.setMargin('pb', value);
              },
              min: 0,
              max: 5
            }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_13__["RangeControl"], {
              ...
              onChange: function onChange(value) {
                return _this11.setMargin('mt', value);
              },
              min: 0,
              max: 5
            }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_8__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_13__["RangeControl"], {
              ...
              onChange: function onChange(value) {
                return _this11.setMargin('mb', value);
              },
              min: 0,
              max: 5
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["withSelect"])(function (select, props) {
